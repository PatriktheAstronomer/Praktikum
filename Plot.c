...
void Plot() {
   ...
   const Int_t n = 2206; //maximum number of lines, starts from second line!
   Double_t x1[n], y1[n];
   ...
   FILE* data;
   data = fopen("Data_termoclanek_Novotny.dat","r"); //source name
...
/*   for(Int_t i = 0; i < n; i++){
   ...
   gr1->SetTitle("Thermoelectrical voltage - calibration");
   gr1->GetXaxis()->SetTitle("Time [s]");
   gr1->GetYaxis()->SetTitle("Thermoelectric Voltage [V]");
